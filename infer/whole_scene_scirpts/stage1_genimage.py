...
ai_prompt = """
A clean, well-composed scene featuring an exotic candle stand with no candle, a transparent drinking glass, a classic glass Coca-Cola bottle, a table with four legs, a chair, a generic adult person standing casually with hand folding hands, and a ceiling fan above. The objects are arranged naturally with good spacing and realistic proportions, with smaller items like the candle stand, glass, and bottle placed on the table. Soft lighting, minimal and realistic style."""
